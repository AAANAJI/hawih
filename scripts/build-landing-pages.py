...
/* header */
.lp-header{position:sticky;top:14px;z-index:40;width:calc(100% - 28px);
  max-width:1180px;margin:14px auto 0;background:rgba(255,255,255,.80);
  backdrop-filter:saturate(150%) blur(16px);border:1px solid var(--line);
  border-radius:20px;box-shadow:0 10px 34px rgba(11,11,16,.10)}
.lp-header__inner{display:flex;align-items:center;justify-content:space-between;
  gap:14px;height:62px;max-width:none;padding-inline:22px}
